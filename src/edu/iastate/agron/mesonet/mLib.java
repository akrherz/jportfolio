...
public class mLib {
  ...
  */
  public static String stationSelect(String portfolio)
   throws SQLException{
    StringBuffer sbuf = new StringBuffer();

    ResultSet rs = dbInterface.callDB("SELECT * from iem_sites WHERE "
     +" portfolio = '"+ portfolio +"' ORDER by s_name ASC");
  ...
  if (rs == null){
    ...
    while( rs.next() ){
      sbuf.append("<tr><td>"+ rs.getString("name") +"</td>\n"
       ...
       +"<td><a href=\"/jportfolio/mesonet/site/contacts.jsp?c_id="+ rs.getString("id") +"\">Delete</a></td></tr>\n");
    } // End of while
  } // End of else
