...
public class mTT {
  ...
  public mTT(String portfolio, String tt_id)
    throws SQLException {
    ResultSet rs = dbInterface.callDB("SELECT *, getUsername(author) as rname "
  ...
  */
  public String printTR() {
    ...
    sbuf.append("<tr id=\""+ this.status +"\">\n"
     +" <td><a href=\"details.jsp?tt_id="+ this.id +"\">"+ this.id +"</a></td>\n"
     +" <td>"+ postDate +"</td>\n"
     +" <td>"+ this.author +"</td>\n");
