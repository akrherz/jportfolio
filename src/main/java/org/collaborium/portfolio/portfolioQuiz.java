...
public class portfolioQuiz {
  ...
  public portfolioQuiz(String thisQuizID, String initQuestions) {
    ...
    ResultSet rs =
        dbInterface.callDB("SELECT * from quizes " + " WHERE quiznum = " + thisQuizID + " ");
    try {
      if (rs.next()) {
  ...
  public String printQ1() {
    ...
    if (question1 == null) question1 = new portfolioQuestion(question1_id);
  ...
  public String printQ2() {
    StringBuffer sbuf = new StringBuffer();
    if (question2 == null) question2 = new portfolioQuestion(question2_id);
  ...
  public String printQ3() {
    StringBuffer sbuf = new StringBuffer();
    if (question3 == null) question3 = new portfolioQuestion(question3_id);
