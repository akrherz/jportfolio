...
/**
 * Logger class for handle error messages from the portfolio. Variables for this class are set in
 * the init servlet files Options include logging to standard out or to a text file.
 */
