...
public class MailMessage {
  ...
  public MailMessage(String mailhost) {
  ...
  public void cc(String c) {
    this.cc.add(c);
  }

  public void bcc(String b) {
    this.bcc.add(b);
  }
  ...
  public void sendAndClose() throws Exception {
    ...
    for (String c : cc) message.addRecipient(Message.RecipientType.CC, new InternetAddress(c));
    for (String b : bcc) message.addRecipient(Message.RecipientType.BCC, new InternetAddress(b));
