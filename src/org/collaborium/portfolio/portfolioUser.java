 ...
 * We shall see how this works, hopefully well :)  It is works, we can have generic 
  ...
  public void valueUnbound(HttpSessionBindingEvent event) {
	...
	try{
		dbInterface.updateDB("UPDATE sessions SET logout = CURRENT_TIMESTAMP "
			+" WHERE username = '"+ userID +"' and logout IS NULL ");
  ...
  public portfolioUser(String newUserID) {
    ...
    try{
      ...
      rs = dbInterface.callDB("SELECT logout from sessions "
        +" WHERE username = '"+newUserID+"' and logout IS NOT NULL "
