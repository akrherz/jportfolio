...
public class jportfolio extends HttpServlet {
  ...
  */
  public String preferencesDialog( portfolioUser thisUser, String thisPageURL) {
	...
	sbuf.append( jlib.topBox("User Preferences:") );
  	...
  	sbuf.append("<font color=\"green\"><blockquote>This page modifies your user preferences.</blockquote></font>\n");

	sbuf.append("<P><B>Current Settings:</B><BR>\n"
		+"<TABLE>\n"
		+"<TR><TD bgcolor=\"#EEEEEE\">Style:</TD><TD>"+ thisUser.getStyle() +"</TD></TR>\n"
		+"<TR><TD bgcolor=\"#EEEEEE\">Email Address:</TD><TD>"+thisUser.getEmailAddress() +"</TD></TR>\n"
		+"<TR><TD bgcolor=\"#EEEEEE\">First Name:</TD><TD>"+ thisUser.getFirstName() +"</TD></TR>\n"
		+"<TR><TD bgcolor=\"#EEEEEE\">Last Name:</TD><TD>"+ thisUser.getLastName() +"</TD></TR>\n"
		+"</TABLE>\n");
	...
	sbuf.append("<P><B>Change Settings:</B><BR>\n"
		...
		+"<TD><input type=\"text\" name=\"email\" value=\""+ thisUser.getEmailAddress() +"\"></TD></TR>\n"
		
		+"<TR><TH>First Name:</TH>\n"
		+"<TD><input type=\"text\" name=\"fName\" value=\""+ thisUser.getFirstName() +"\"></TD></TR>\n"
		
		+"<TR><TH>Last Name:</TH>\n"
		+"<TD><input type=\"text\" name=\"lName\" value=\""+ thisUser.getLastName() +"\"></TD></TR>\n"
  ...
  */
  public String postPortfolio(portfolioUser thisUser, HttpServletRequest req) {
	...
	if ( sysPass.equalsIgnoreCase( settings.systemPassword ) ) {
	  	...
	  	jlib.updateDB("INSERT into portfolios(portfolio, name, about, instructor, passwd) "
  			+" VALUES( '"+portfolioID+"', '"+portfolioName+"', '"+about+"', '"+instructor+"', '"+passwd+"') ");
  
 		// Create entry in motds, just as a place holder till it gets replaced
 	 	jlib.updateDB("INSERT into motd(portfolio, body) VALUES('"+portfolioID+"', 'Welcome Users.') ");
 
 		// Create an administrative entry for this user
 	 	jlib.updateDB("INSERT into admins(portfolio, admin) VALUES ('"+portfolioID+"', '"+thisUser.getUserID()+"')");
		
		// Create a student user account
		jlib.updateDB("INSERT into students(username, portfolio) VALUES('"+thisUser.getUserID()+"', '"+portfolioID+"') ");
  	
 	 	sbuf.append("Your Portfolio has been created sucessfully!\n"
			+" You can now <a href=\"/jportfolio/login.jsp?portfolio="+portfolioID+"\">log in</a> \n"
			+" to your portfolio and configure it.\n");
 	} else {
 	 	sbuf.append("Incorrect system password, email support@iitap.iastate.edu if you need assistance");
	}
  ...
  */ 
  public String createPortfolio()
  {
	...
	sbuf.append("<font class=\"instructions\"><blockquote>This page is intended for instructors to create class portfolios.  In order\n"
	+" to register a portfolio, a system administration password needs to be known.\n</blockquote></font>");
	
  	sbuf.append("<BR><FORM method='POST' name='create' action='"+thisPageURL+"'>\n"
  ...
  */
  ...
  +" <li><a class=\"commands\" href='/jportfolio/login.jsp?logoutPortfolio=yes'>Switch Portfolios</a></li>\n"
		+"    <LI><a class=\"commands\" href='"+thisPageURL+"?mode=u'>Create Portfolio</a></LI>\n"
   ...
   if ( portfolio != null ) {
     sbuf.append("    <LI><a class=\"commands\" "
      +" href='"+thisPageURL+"?mode=g'>List group members</a></LI>\n");
     sbuf.append("    <LI><a class=\"commands\" "
      +" href='"+thisPageURL+"?mode=h'>List portfolio colleagues</a></LI>\n");
     sbuf.append(" <LI><a class=\"commands\" "
      +" href='"+jlib.httpBase+"/jsp/user/myGrades.jsp' "
      +" target=\"_new\">Show my grades</a></LI>\n");
   } // End of if
	
	sbuf.append(" <LI><a class=\"commands\" href='"+thisPageURL+"?mode=v'>Set preferences</a></LI>\n");
	sbuf.append("</ul>\n");
	sbuf.append( jlib.botBox());
  ...
  */
  public String badIntro()
  {
	...
	myBuffer.append("<H3 align=\"CENTER\">Welcome to the Portfolio Manager.</H3>\n"
		...
		+ " <a href='"+thisPageURL+"?mode=i'>Create a New User Account.</blockquote><br>\n"
  ...
  */
  public String portfolioMain( portfolioUser thisUser ) 
  {
    ...
    try {
      rs = dbInterface.callDB("SELECT m.body, "
    ...
    if (porthome != null && ! porthome.equalsIgnoreCase("/jportfolio/servlet/"))
      sbuf.append( jlib.alertBox("Portfolio Message",
  "You are currently accessing the <i>generic portfolio interface.</i>"
   +" The "+ className +" portfolio has a custom interface which can be "
   ...
   +" content will be missing.\n") );
    ...
    sbuf.append("<P><B><I>Message of the Day (MOTD):</I></b>\n"
      ...
      +"| <a href=\""+thisPageURL+"?mode=n\">List all MOTDs</a> |<BR>\n"
      +"<BR>"+ motd +"<BR>"
      +"</blockquote>\n");
		
    sbuf.append("<P><B><I>Information:</I></b>\n"
      +"<blockquote>\n"
      +"<B>Portfolio Administrator:</B> &nbsp; &nbsp; "+instructor+"\n");
  ...
  */
  public String listAllMotd(portfolioUser thisUser) {
	...
	try {
		rs = dbInterface.callDB("SELECT body, to_char(issue, 'DD Month YYYY HH12:MI AM') "
			+ " as issued, issue "
		...
		while (rs.next()) {
			...
			+"<BR><blockquote>"+rs.getString("body")+"</blockquote><HR>");
		}
	}
	catch( Exception ex) {
