...
public class ChatDispatch extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    String method =
        request.getParameter("method"); // request chat method of interaction

    if (callMethod == null)
      callMethod = "x"; // let us drop to the the default
  ...
  // One of the main test of jsib will be a test of the applet to server
  // communication.  Though note erequired for this the testing of subapps to
  // Portfolio issues, it does increase the range of issue involved.
  public String body(portfolioUser thisUser, String method) {
    ...
    myBuffer.append(
        "<font color=\"green\">This is a simple chat applet. You join the discussion in progress when"
        +
